...
**Remember: because of Engineering EXPO, class on Monday 24th Feb is an optional "review" class with no new material**
...
Write simple calculator
  ...
  * The webpage should give the complete equation somewhere
    * for example: 4 + 5 = 9
