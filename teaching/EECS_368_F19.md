 ...
 * The JavaScript project is due on Nov 8th (moved because Dr. Gill missed a class). 
 * Write a non-trivial program in JavaScript
 * One example is connect 4, for two players, with DOM/HTML for display.
 * Please set up an appointment to demo your project.
 * You will also hand in your listing (or provide a link to a github repo.)
 * Use the <a href="http://ku-fpg.github.io/workbook/EECS_368/">cover sheet.</a>

## Homework and Other assignments
 
 * There is Haskell homework due on Wednesday the 6th, by close of business
 * Use the <a href="">cover sheet.</a>
